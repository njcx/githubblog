...
简介：等级保护与iso27001安全合规审计平台是为安全部门提供一个直观显示并能轻松管理的公司安全合规平台，应用目标是初步实现：1）从GRC系统中能根据等级保护和ISO27001相关条例能从系统第 3 页点融GRC项目需求分析说明书中获取对应的公司安全合规控制点；2）对于动态的安全检查项目，能提供不同用户不同等级的权限使得用户能发布安全检查，执行安全检查，等级评估，等级更改，差距评估等功能。作用范围是所有保存在系统数据库内的安全事件，安全检查项目，安全合规的控制点等。背景材料是借鉴了安全牛的GRC Demo。
